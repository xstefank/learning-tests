...
public class TramLtApplication {

	public static void main(String[] args) {
		SpringApplication.run(TramLtApplication.class, args);
	}
	...
	@Bean
	public CommandDispatcher testCommandDispatcher(Handler1 handler1) {
		return new SagaCommandDispatcher("testCommandDispatcher", handler1.commandHandlers());
	}
